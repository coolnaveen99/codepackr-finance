...
**Live calculator:** [finance.codepackr.com/net-worth-calculator](https://finance.codepackr.com/net-worth-calculator)
...
Use this calculator when you need a transparent estimate for **net worth calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Assets by type**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Liabilities by type**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Optional liquid or investable asset classifications**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Total assets**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Total liabilities**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Net worth**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Liquid net worth**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Liability ratios**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Net worth = total assets - total liabilities. Classifications help distinguish accessible cash from illiquid wealth.
