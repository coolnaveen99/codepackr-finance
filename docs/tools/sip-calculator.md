...
**Live calculator:** [finance.codepackr.com/sip-calculator](https://finance.codepackr.com/sip-calculator)

Calculate Systematic Investment Plan (SIP) returns, wealth accumulation, and annual step-up compounding.

## 1. What this calculator answers

Use this calculator when you need a transparent estimate for **sip calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Periodic contribution**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Expected annual return**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Investment duration**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Optional annual step-up**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Invested capital**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Estimated gains**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Maturity value**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **A year-by-year growth chart**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> For a regular contribution, FV = PMT * (((1 + r)^n - 1) / r) * (1 + r) when contributions occur at period end.
...
- [Rule of 72 Calculator](./rule-of-72-calculator.md) - Calculate investment doubling time, inflation purchasing power halving, and required compound interest rates using the Rule of 72.
