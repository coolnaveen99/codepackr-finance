...
**Live calculator:** [finance.codepackr.com/emergency-fund-calculator](https://finance.codepackr.com/emergency-fund-calculator)
...
Use this calculator when you need a transparent estimate for **emergency fund calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Essential monthly expenses**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Income stability**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Dependents**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Existing liquid savings**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Target months of cover**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Recommended reserve**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Current coverage**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Funding gap**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Time to reach the target at a chosen monthly contribution**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Emergency target = essential monthly expenses * target coverage months.
...
- [Rent vs. Buy Calculator](./rent-vs-buy-calculator.md) - Compare 30-year long-term net wealth outcomes of purchasing a home vs. renting and investing down payment capital in equity markets.
