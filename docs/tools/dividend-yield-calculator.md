...
**Live calculator:** [finance.codepackr.com/dividend-yield-calculator](https://finance.codepackr.com/dividend-yield-calculator)

Calculate forward dividend yield, yield on cost (YOC), and multi-year DRIP (Dividend Reinvestment Plan) compounding wealth projections.

## 1. What this calculator answers

Use this calculator when you need a transparent estimate for **dividend yield & drip calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Share price**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Dividend per share**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Dividend growth**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Share count**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Reinvestment rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Projection period**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Forward yield**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Yield on cost**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Dividend income**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Share accumulation**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **DRIP projection**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Dividend yield = annual dividend per share / current share price; DRIP reinvests distributions into additional shares.
...
- [SIP Calculator](./sip-calculator.md) - Calculate Systematic Investment Plan (SIP) returns, wealth accumulation, and annual step-up compounding.
- [Lumpsum Investment Calculator](./lumpsum-calculator.md) - Compute compound growth, maturity wealth, and inflation-adjusted real purchasing power for one-time investments.
- [CAGR Calculator (Compound Annual Growth)](./cagr-calculator.md) - Calculate Compound Annual Growth Rate, annualized geometric returns, capital multiples, and holding trajectories.
- [ROI Calculator (Return on Investment)](./roi-calculator.md) - Calculate net return on investment, annualized holding period return, and capital multiples after fees.
- [Compound Interest Calculator](./investment-calculator.md) - Calculate compound interest growth with periodic deposits, flexible compounding frequencies, and APY rates.
