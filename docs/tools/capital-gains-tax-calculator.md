...
**Live calculator:** [finance.codepackr.com/capital-gains-tax-calculator](https://finance.codepackr.com/capital-gains-tax-calculator)
...
Use this calculator when you need a transparent estimate for **capital gains tax calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Purchase cost**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Sale proceeds**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Asset type**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Eligible expenses**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Configured tax treatment**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Capital gain**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Taxable gain**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Applicable rate**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Estimated tax**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Net proceeds**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Capital gain = sale consideration - adjusted cost - eligible expenses; classification depends on asset type and holding period.
...
- [Income Tax Calculator](./income-tax-calculator.md) - Estimate income tax liability under the New and Old Tax Regimes with standard deduction, 87A rebate, and slab breakdowns.
- [GST Calculator](./gst-calculator.md) - Calculate GST inclusive and exclusive invoice amounts with statutory slab breakdowns (0%, 3%, 5%, 12%, 18%, 28%) and CGST/SGST/IGST splits.
