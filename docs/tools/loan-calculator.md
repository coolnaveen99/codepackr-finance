...
**Category:** Loans & Debt  
**Live calculator:** [finance.codepackr.com/loan-calculator](https://finance.codepackr.com/loan-calculator)
...
- **Annual interest rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Optional extra payment**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **EMI**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Total repayment**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Total interest**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Principal-versus-interest breakdown**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **An amortization timeline**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> EMI = P * r * (1 + r)^n / ((1 + r)^n - 1), where P is principal, r is the periodic rate, and n is the number of payments.
