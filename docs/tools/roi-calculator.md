...
**Live calculator:** [finance.codepackr.com/roi-calculator](https://finance.codepackr.com/roi-calculator)
...
- **Exit value**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Fees or costs**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Net profit**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **ROI percentage**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Annualized return**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Capital multiple**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> ROI = net profit / initial investment * 100; annualization assumes a comparable holding-period convention.
