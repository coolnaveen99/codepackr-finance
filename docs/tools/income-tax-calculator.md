...
**Live calculator:** [finance.codepackr.com/income-tax-calculator](https://finance.codepackr.com/income-tax-calculator)

Estimate income tax liability under the New and Old Tax Regimes with standard deduction, 87A rebate, and slab breakdowns.

## 1. What this calculator answers

Use this calculator when you need a transparent estimate for **income tax calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Taxable income components**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Deductions**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Regime selection**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Age or taxpayer status**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Applicable fiscal-year assumptions**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Taxable income**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Slab-by-slab liability**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Rebates**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Surcharge or cess treatment where configured**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Regime comparison**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Tax is calculated by applying the selected regime's slabs and deductions, then subtracting eligible rebates and adding configured statutory charges.
...
- [Capital Gains Tax Calculator](./capital-gains-tax-calculator.md) - Calculate Short-Term (STCG) and Long-Term (LTCG) capital gains taxes on equity, real estate, and debt under post-Budget 2024 tax rules.
