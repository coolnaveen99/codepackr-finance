...
**Live calculator:** [finance.codepackr.com/lumpsum-calculator](https://finance.codepackr.com/lumpsum-calculator)
...
Use this calculator when you need a transparent estimate for **lumpsum investment calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Initial investment**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Holding period**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Optional inflation rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Profit**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Nominal return**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Inflation-adjusted purchasing power**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> FV = P * (1 + r / m)^(m * t); real value is the nominal result discounted by inflation over t years.
