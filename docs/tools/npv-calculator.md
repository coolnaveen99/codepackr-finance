...
**Live calculator:** [finance.codepackr.com/npv-calculator](https://finance.codepackr.com/npv-calculator)
...
- **Periodic cash flows**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Discount rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Optional terminal value**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Present value of inflows**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Present value of outflows**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **NPV**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Profitability index**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Payback indicators**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
