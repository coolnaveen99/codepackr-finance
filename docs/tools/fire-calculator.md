...
**Live calculator:** [finance.codepackr.com/fire-calculator](https://finance.codepackr.com/fire-calculator)
...
Use this calculator when you need a transparent estimate for **fire calculator (financial independence)**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Annual spending**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Current investments**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Savings rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Selected FIRE model**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Lean**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Standard**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Fat**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Coast FIRE targets**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Progress**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **An estimated independence timeline**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> FIRE target = annual spending / selected safe withdrawal rate; the timeline compounds current assets and new savings.
...
- [Retirement Corpus Calculator](./financial-planner.md) - Analyze retirement readiness, projected vs required corpus, corpus sustainability, savings gap, and Monte Carlo scenarios.
