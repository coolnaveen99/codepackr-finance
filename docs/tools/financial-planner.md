...
**Live calculator:** [finance.codepackr.com/financial-planner](https://finance.codepackr.com/financial-planner)
...
Use this calculator when you need a transparent estimate for **retirement corpus calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Current corpus**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Age**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Target retirement age**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Current expenses**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Inflation**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Expected return**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Planned savings**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Required corpus**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Projected corpus**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Savings gap**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Withdrawal sustainability**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Scenario comparisons**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Future expenses grow with inflation; the required corpus is estimated from retirement spending and a selected withdrawal assumption.
...
- [Inflation & Purchasing Power Calculator](./inflation-calculator.md) - Project future living expenses, purchasing power erosion, and rule-of-72 price doubling timelines.
- [Future Value Calculator (TVM)](./future-value-calculator.md) - Project future worth of starting capital combined with recurring cash deposits under discrete compounding schedules.
- [Savings Goal Projector](./savings-goal-calculator.md) - Project required monthly savings across Savings Accounts, RDs, FDs, Liquid, Ultra-Short, and Arbitrage funds to reach your target financial milestone.
- [FIRE Calculator (Financial Independence)](./fire-calculator.md) - Compute Standard, Lean, Fat, and Coast FIRE targets, safe withdrawal rates (SWR), and timeline to early retirement.
- [EPF Calculator (Provident Fund)](./epf-calculator.md) - Project employee and employer EPF retirement corpus accumulation, 8.25% EPFO interest compounding, and salary increment trajectories.
