...
**Live calculator:** [finance.codepackr.com/hra-calculator](https://finance.codepackr.com/hra-calculator)

Compute tax-exempt House Rent Allowance (HRA) under Section 10(13A) Rule 2A, compare metro vs non-metro limits, and estimate tax savings.

## 1. What this calculator answers

Use this calculator when you need a transparent estimate for **hra exemption calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.
...
- **HRA received**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Rent paid**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **City classification**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Other income**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Old-regime assumptions**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Exempt HRA**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Taxable HRA**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Eligible deduction components**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Estimated tax impact**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Exemption is the minimum of configured salary-linked, rent-minus-10%-salary, and actual HRA components.
...
- [CTC to In-Hand Salary Calculator](./ctc-to-in-hand-calculator.md) - Convert annual Cost to Company (CTC) into monthly take-home salary, accounting for EPF, Gratuity, Professional Tax, and TDS.
