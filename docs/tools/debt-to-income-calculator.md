...
**Category:** Loans & Debt  
**Live calculator:** [finance.codepackr.com/debt-to-income-calculator](https://finance.codepackr.com/debt-to-income-calculator)
...
Use this calculator when you need a transparent estimate for **debt-to-income (dti) ratio calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Gross monthly income and recurring monthly debt obligations**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Separated into housing and non-housing debt**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Front-end DTI**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Back-end DTI**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Remaining borrowing capacity**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **An affordability interpretation**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> DTI = qualifying monthly debt / gross monthly income * 100.
