...
**Category:** Loans & Debt  
**Live calculator:** [finance.codepackr.com/loan-prepayment-calculator](https://finance.codepackr.com/loan-prepayment-calculator)
...
Use this calculator when you need a transparent estimate for **loan prepayment calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Outstanding principal**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Remaining term**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Regular payment**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Prepayment amount**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Prepayment frequency**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Interest saved**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Revised payoff date**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Term reduction**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Comparison with the original schedule**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Each prepayment reduces the next period's interest because interest is calculated on the lower outstanding balance.
...
- [Mortgage Affordability Calculator](./mortgage-affordability-calculator.md) - Determine your maximum home purchasing budget based on gross income, existing debt obligations, and Fannie Mae DTI guidelines.
