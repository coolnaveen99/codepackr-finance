...
**Live calculator:** [finance.codepackr.com/investment-calculator](https://finance.codepackr.com/investment-calculator)
...
Use this calculator when you need a transparent estimate for **compound interest calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Starting balance**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Recurring deposits**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Annual rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Principal contributed**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Interest earned**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Ending balance**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **An interactive compounding curve**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> FV combines the compounded starting balance with the future value of periodic deposits.
