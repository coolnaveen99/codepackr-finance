...
**Live calculator:** [finance.codepackr.com/inflation-calculator](https://finance.codepackr.com/inflation-calculator)

Project future living expenses, purchasing power erosion, and rule-of-72 price doubling timelines.

## 1. What this calculator answers

Use this calculator when you need a transparent estimate for **inflation & purchasing power calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Current price or expense**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Inflation rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Optional target purchasing power**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Future cost**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Purchasing-power loss**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Equivalent present value**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Rule-of-72 doubling estimate**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
