...
**Category:** Loans & Debt  
**Live calculator:** [finance.codepackr.com/mortgage-affordability-calculator](https://finance.codepackr.com/mortgage-affordability-calculator)
...
Use this calculator when you need a transparent estimate for **mortgage affordability calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Gross income**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Recurring debt**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Down payment**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Interest rate**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Loan term**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Property costs**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Target DTI limit**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Maximum payment**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Affordable loan amount**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Estimated home price**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Constraint-by-constraint breakdown**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Affordable payment is bounded by the selected DTI limit and converted to principal using the loan payment equation.
...
- [EMI Calculator](./loan-calculator.md) - Calculate monthly loan EMI, total interest, and comprehensive repayment timeline with extra prepayment scenarios.
- [Loan Amortization Calculator](./loan-amortization-calculator.md) - Generate complete annual and monthly loan amortization ledgers with principal reduction and cumulative interest tracking.
- [Loan Prepayment Calculator](./loan-prepayment-calculator.md) - Calculate interest savings and months shaved off your loan term through monthly or annual lump-sum prepayments.
- [Debt-to-Income (DTI) Ratio Calculator](./debt-to-income-calculator.md) - Assess borrowing capacity, front-end vs back-end debt burden, and lending approval probability under CFPB guidelines.
- [Simple Interest Calculator](./simple-interest-calculator.md) - Calculate simple (non-compounding) interest and maturity amount on a fixed principal with yearly amortized schedule.
