...
**Live calculator:** [finance.codepackr.com/cagr-calculator](https://finance.codepackr.com/cagr-calculator)
...
Use this calculator when you need a transparent estimate for **cagr calculator (compound annual growth)**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Starting value**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Ending value**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Holding period in years**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **CAGR**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Total gain**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Capital multiple**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **An annualized growth path**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
