...
**Category:** Loans & Debt  
**Live calculator:** [finance.codepackr.com/simple-interest-calculator](https://finance.codepackr.com/simple-interest-calculator)
...
- **Time period**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **With the time unit made explicit**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Simple interest**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Maturity value**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **A period summary**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> I = P * r * t and A = P + I. The rate is not applied to accumulated interest.
