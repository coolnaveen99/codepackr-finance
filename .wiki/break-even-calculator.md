...
**Live calculator:** [finance.codepackr.com/break-even-calculator](https://finance.codepackr.com/break-even-calculator)
...
Use this calculator when you need a transparent estimate for **break-even calculator**. It is intended for planning and comparison: change one assumption at a time, observe the effect on the outputs, and keep the assumptions with any result you save. The result is an estimate, not a quote, approval, tax filing, investment guarantee, or professional opinion.

## 2. Inputs

The main inputs are:

- **Total fixed costs**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Variable cost per unit**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Selling price per unit**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
- **Expected unit sales for the margin-of-safety calculation**: enter the value that describes your current scenario. Keep its unit and time period consistent with the other fields.
...
- **Break-even volume**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Break-even revenue**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Contribution margin per unit and ratio**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Margin of safety**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Expected revenue**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Total cost**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
- **Operating profit or loss**: use this as a decision signal, then verify it against the detailed schedule, table, or chart.
...
> Contribution margin per unit = selling price per unit - variable cost per unit; break-even units = fixed costs / contribution margin per unit; operating profit = revenue - fixed costs - variable costs.
